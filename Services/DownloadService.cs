...
public class DownloadService : IDownloadService
{
    ...
    private async Task DownloadFileAsync(DownloadTask task, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            using var response = await _httpClient.GetAsync(task.Entry.Url, HttpCompletionOption.ResponseHeadersRead, linkedCts.Token);
            ...
            await using var fileStream = new FileStream(task.OutputPath, FileMode.Create, FileAccess.Write, FileShare.None, 81920, true);
